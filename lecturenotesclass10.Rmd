...
- How many patients were enrolled in the clinical trial?
  16848 patients were enrolled in the clinical trials. 

- What is the probability a randomly selected patient received the placebo?
  There is a 51% chance that a randomly selected patient received the placebo.
- What is the probability a randomly selected patient received the placebo
...
```{r summarize_rolls}
roll_results %>%
  summarise(event_1 = mean(event_1),
            event_2 = mean(event_2))
```
